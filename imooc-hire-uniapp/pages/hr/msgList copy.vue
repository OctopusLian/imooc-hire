	...
	<view>
		...
		<view class="navigation-bar" style="z-index: 77777;">
			...
			<view class="nav-middle">
				<text class="page-title">风间影月</text>
				<text class="page-info">技术经理</text>
			</view>
		...
		<view class="msg-list-box" style="width: 100%;">
			...
			<scroll-view 
				...
				<view id="msgViewList" class="msg-view-list">
					...
					<!-- 文字 -->
					<view class="msg-line-right">
						<view class="every-msg-right">
							
							<view class="msg-box-right">
								<text class="msg-content-right">你好啊~~你好啊~你好啊~~你好啊~你~你好啊~~你好啊~你好啊~~你好啊~</text>
					...
					<view class="msg-line-right">
						<view class="every-msg-right">
							...
							<!-- <image src="../../static/images/face500k.jpg" mode="heightFix" class="chat-image"></image> -->
							<image src="../../static/images/eggs.jpeg" @click="previewImage('../../static/images/eggs.jpeg')" mode="heightFix" class="chat-image-right"></image>
					...
					<view class="msg-line-left">
						<view class="every-msg-left">
							...
							<image src="../../static/images/face500k.jpg" @click="previewImage('../../static/images/face500k.jpg')" mode="heightFix" class="chat-image-left"></image>
							<!-- <image src="../../static/images/eggs.jpeg" mode="heightFix" class="chat-image"></image> -->
						</view>
					</view>
					
					<!-- 表情 -->
					<!-- 文本中显示：你好啊~[/笑脸]，显示的时候解析 -->
					<view class="msg-line-right">
						<view class="every-msg-right">
							
							<view class="msg-box-right">
								<!-- <text class="msg-content-right">笑死我了~~<image src="../../static/images/gif/11摔东西.gif" class="face-iamge"></image></text> -->
								<!-- <rich-text class="msg-content-right"></rich-text> -->
								<rich-text :nodes="replaceAndShowFace(faceContent)" preview="true" class="msg-content-right"></rich-text>
								<image src="../../static/icons/chat-right-arrow.png" class="chat-right-arrow"></image>
							</view>
					...
					<view class="msg-line-left">
						<view class="every-msg-left">
							...
							<view class="msg-box-left">
								<image src="../../static/icons/chat-left-arrow.png" class="chat-left-arrow"></image>
								<rich-text :nodes="replaceAndShowFace(faceContent2)" preview="true" class="msg-content-left"></rich-text>
							</view>
						</view>
					</view>
					...
					<!-- 语音 -->
					<view class="msg-line-right">
						<view class="every-msg-right" style="max-width: 96%;">
							
							<view class="msg-box-right">
								<!-- <view class="msg-content-right-speak" style=""> -->
								<view 
									:class="{'msg-content-right-speak':!rightVoiceTouched, 'msg-content-right-speak-touched': rightVoiceTouched}"
									@touchstart="touchstartRightVoice"
									@touchend="touchendRightVoice"
									@click="playVoice(tempFlag[0])"
									class="msg-content-right-speak" style="">
									<text class="seconds-right" :style="{'width': speakRealWidth + 'upx'}">{{speakSeconds}}″</text>
								...
								<image src="../../static/icons/chat-right-arrow.png" v-show="!rightVoiceTouched" class="chat-right-arrow"></image>
								<image src="../../static/icons/chat-right-arrow-touched.png" v-show="rightVoiceTouched" class="chat-right-arrow"></image>
							</view>
					...
					<view class="msg-line-left">
						<view class="every-msg-left" style="max-width: 96%;">
							...
							<view class="msg-box-left">
								<image src="../../static/icons/chat-left-arrow.png" v-show="!leftVoiceTouched" class="chat-left-arrow"></image>
								<image src="../../static/icons/chat-left-arrow-touched.png" v-show="leftVoiceTouched" class="chat-left-arrow"></image>
								<!-- <view class="msg-content-left-speak"> -->
								<view 
									:class="{'msg-content-left-speak':!leftVoiceTouched, 'msg-content-left-speak-touched': leftVoiceTouched}"
									@touchstart="touchstartLeftVoice"
									@touchend="touchendLeftVoice"
									@click="playVoice(tempFlag[1])"
									class="msg-content-left-speak">
									
									<image src="../../static/icons/speak/msg-right-spearker.png" v-show="!voicePlayObject['voiceIsPlay'+tempFlag[1]]" class="icon-speaker"></image>
									<image src="../../static/icons/speak/msg-right-spearking.gif" v-show="voicePlayObject['voiceIsPlay'+tempFlag[1]]" class="icon-speaker"></image>
									
									<text class="seconds-left" :style="{'width': speakRealWidth + 'upx'}">{{speakSeconds}}″</text>
								</view>
								
								<image v-show="msgVoiceRead" src="../../static/icons/speak/msg-voice-unread.png" class="icon-msg-voice-unread"></image>
							</view>
						</view>
					</view>
								...
								<view class="msg-content-right">
									...
									<view class="resume-wrapper" >
										...
										<view class="resume-words-wrapper">
											<text class="resume-name-words">风间影月的简历</text>
											<text class="resume-position-words">技术经理</text>
										</view>
									</view>
								</view>
								<image src="../../static/icons/chat-right-arrow.png" class="chat-right-arrow"></image>
						...
						<view class="every-msg-right">
							...
							<view class="msg-box-right">
								<view class="msg-content-right">
									...
									<view class="resume-wrapper" @click="showInterviewDetail">
					...
					<view class="msg-line-left">
						<view class="every-msg-left">
							...
							<view class="msg-box-left">
								...
								<view class="msg-content-left">
									<text class="">抱歉~因个人原因暂时无法前来参加面试</text>
									
									<view class="resume-wrapper" @click="showInterviewDetail">
										<image src="../../static/icons/icon-not-agree.png" class="icon-info"></image>
										<view class="resume-words-wrapper">
											<text class="resume-name-words">面试邀约</text>
											<text class="resume-position-words">查看详情</text>
										</view>
					...
					<view class="msg-line-left">
						<view class="every-msg-left">
							...
							<view class="msg-box-left">
								...
								<view class="msg-content-left">
									<text class="">OK~我接受面试，准时来参加~</text>
									
									<view class="resume-wrapper" @click="showInterviewDetail">
										<image src="../../static/icons/icon-agree.png" class="icon-info"></image>
										<view class="resume-words-wrapper">
											<text class="resume-name-words">面试邀约</text>
											<text class="resume-position-words">查看详情</text>
										</view>
					...
					<!-- <view>
						...
						<button @tap="playVoice2">播放录音</button>
					</view> -->
					...
					<view class="msg-line-right">
						<view class="every-msg-right">
							...
							<view class="video-cover-box" @click="watchVideo('src123', 500, 300)">
								<image src="../../static/images/eggs.jpeg" mode="heightFix" class="chat-video-right"></image>
								<view class="play-box">
									<view class="gray-mask"></view>
									<image src="../../static/icons/msg/icon-viode-play.png" class="icon-viode-play"></image>
								</view>
								<text class="video-times">05:26</text>
							</view>
					...
					<view class="msg-line-left">
						<view class="every-msg-left">
							...
							<view class="video-cover-box-left">
								<image src="../../static/icons/msg/cover_temp1.jpg" @click="" mode="heightFix" class="chat-video-right"></image>
								<view class="play-box">
									<view class="gray-mask"></view>
									<image src="../../static/icons/msg/icon-viode-play.png" class="icon-viode-play"></image>
								</view>
					...
					<block v-for="(m, index) in allMSGList" :key="index">
						...
						<!-- 候选人发简历 -->
						<view class="msg-line-right" v-if="m.msgType == MSGTYPE.RESUME && m.msgSource == MSGSOURCE.SENDER">
							<view class="every-msg-right">
								...
								<view class="msg-box-right">
									<view class="msg-content-right">
										...
										<view class="resume-wrapper" @click="showResumeDetail(1001)">
											<image src="../../static/icons/chat-my-resume.png" class="icon-my-resume"></image>
											<view class="resume-words-wrapper">
												<text class="resume-name-words">{{m.msgContent.name}}的简历</text>
												<text class="resume-position-words">{{m.msgContent.position}}</text>
											</view>
										</view>
									</view>
									<image src="../../static/icons/chat-right-arrow.png" class="chat-right-arrow"></image>
						...
						<view class="msg-line-left" v-if="m.msgType == MSGTYPE.RESUME && m.msgSource == MSGSOURCE.RECEIVER">
							<view class="every-msg-left">
								<image src="../../static/images/me.png" class="face-icon"></image>
								...
								<view class="msg-box-left">
									...
									<view class="msg-content-left">
										...
										<view class="resume-wrapper"  @click="showResumeDetail(2022)">
											<image src="../../static/icons/chat-my-resume.png" class="icon-my-resume"></image>
											<view class="resume-words-wrapper">
												<text class="resume-name-words">{{m.msgContent.name}}的简历</text>
												<text class="resume-position-words">{{m.msgContent.position}}</text>
						...
						<!-- 面试邀约 -->
						<view class="msg-line-right" v-if="m.msgType == MSGTYPE.INVITE && m.msgSource == MSGSOURCE.SENDER">
							<view class="every-msg-right">
						...
						<view class="msg-time-wrapper" v-if="m.msgType == MSGTYPE.MSG_INTERVIEW_CANCEL && userIdentityType == 1">
							<text>您已取消面试</text>
						</view>
						<view class="msg-time-wrapper" v-if="m.msgType == MSGTYPE.MSG_INTERVIEW_CANCEL && userIdentityType == 2">
							<text>对方已取消面试</text>
						</view>
						
						<view class="msg-line-left" v-if="m.msgType == MSGTYPE.INVITE && m.msgSource == MSGSOURCE.RECEIVER">
							<view class="every-msg-left">
								<image src="../../static/images/me.png" class="face-icon"></image>
						...
						<view class="msg-time-wrapper" v-if="m.msgType == MSGTYPE.MSG_INTERVIEW_ACCEPT && userIdentityType == 1">
							<text>对方已接受面试</text>
						</view>
						<view class="msg-time-wrapper" v-if="m.msgType == MSGTYPE.MSG_INTERVIEW_ACCEPT && userIdentityType == 2">
							<text>您已接受面试</text>
						</view>
						
						<view class="msg-time-wrapper" v-if="m.msgType == MSGTYPE.MSG_INTERVIEW_REFUSE && userIdentityType == 1">
							<text>对方已拒绝面试</text>
						</view>
						<view class="msg-time-wrapper" v-if="m.msgType == MSGTYPE.MSG_INTERVIEW_REFUSE && userIdentityType == 2">
							<text>您已拒绝面试</text>
						</view>
						
						<!-- 录用通知 -->
						<view class="msg-line-right" v-if="m.msgType == MSGTYPE.JOBOFFER && m.msgSource == MSGSOURCE.SENDER">
							<view class="every-msg-right">
						...
						<view class="msg-line-left" v-if="m.msgType == MSGTYPE.JOBOFFER && m.msgSource == MSGSOURCE.RECEIVER">
							<view class="every-msg-left">
								<image src="../../static/images/me.png" class="face-icon"></image>
		...
		<view class="plus-board-wrapper" :animation="plusAnimationData" style="height: 265px">
			<view class="plus-icons-box">
				...
				<view class="plus-item" @click="sendResume()">
					<view class="plus-icons-wrapper">
				...
				<view class="plus-item" @click="createInterviewInvite()">
					<view class="plus-icons-wrapper">
				...
				<view class="plus-item" @click="interviewSuccess()">
					<view class="plus-icons-wrapper">
...
<script>
	...
	export default {
		...
		onLoad(options) {
			...
			var resumeUserId = options.resumeUserId;
		...
		methods: {
			...
			showResumeDetail(id) {
				console.log(id)
				uni.navigateTo({
					url: "../candidate/resume/previewResumePage",
					animationType: "slide-in-bottom",
					success() {
					}
				});
