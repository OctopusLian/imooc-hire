<template>
    <el-row :gutter="40" class="panel-group">
        ...
        <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
            <!-- 网站招聘人员总数 -->
            <div class="card-panel" @click="handleSetLineChartData('newHRs')">
                <div class="card-panel-icon-wrapper icon-message">
                    <svg-icon icon-class="user" class-name="card-panel-icon" />
                </div>
                <div class="card-panel-description">
                    <div class="card-panel-text">HR总数</div>
        ...
        <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
            <!-- 网站入驻企业总数 -->
            <div class="card-panel" @click="handleSetLineChartData('newCompanies')">
                <div class="card-panel-icon-wrapper icon-money">
                    <svg-icon icon-class="tree" class-name="card-panel-icon" />
                </div>
                <div class="card-panel-description">
                    <div class="card-panel-text">企业总数</div>
        ...
        <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
            <!-- 成功入职 -->
            <div class="card-panel" @click="handleSetLineChartData('successCandidates')">
                <div class="card-panel-icon-wrapper icon-shopping">
                    <svg-icon icon-class="skill" class-name="card-panel-icon"/>
                </div>
                <div class="card-panel-description">
                    <div class="card-panel-text">成功入职</div>
                    <count-to :start-val="0" :end-val="13600" :duration="2000" class="card-panel-num" />
                </div>
            </div>
        </el-col>
    </el-row>
