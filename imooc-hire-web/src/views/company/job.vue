        ...
        <div class="form-container">
                <el-form ref="dataForm" v-model="industry" label-width="80px" size="mini" label-position="left" style="width: 360px; margin-left:50px;">
                    <el-form-item label="职位名称">
                        <el-input v-model="industry.name" placeholder="职位名称" style="width: 200px;margin-right: 5px;" class="filter-item"/>
                    </el-form-item>
            ...
            <aside class="hint">
                <span style="font-size: 12px; color: gray;">
                    <p style="line-height: 20px;margin-top:5px;">
                        ...
                        1、【创建】为新增职位，未选中职位则创建顶级职位分类，选中则创建该节点下子分类，最后一级分类不可创建；<br>
                        2、【更新】前需要点击任何一项职位，在表单中修改后点击【更新】即可提交修改；<br>
                        3、【删除】前需要选中任何一项职位后，方可点击删除；<br>
                        4、【清空】清除表单中的待提交信息。<br>
                    </p>

                    <!-- <span style="font-size: 14px; color: red;font-weight: bold;">
                        点击职位后，需要查询后端，用户端app每次从缓存中获得，后端不需要<br>
...
<script>
import { getTopList, getChildrenJobTypeList, createNode, updateNode, deleteNode } from '@/api/jobType';
...
export default {
    ...
    data() {
        return {
            ...
            industry: {
                ...
                name: "",
                sort: null,
                fatherId: 0,    // 为0则当前为第一级分类，否则当前为fatherId所对应职位的子分类
                isLeaf: false,
    ...
    methods: {
        ...
        loadNode(node, resolve) {
            ...
            getChildrenJobTypeList(industryId).then(response => {
