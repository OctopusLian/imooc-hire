    ...
    <div class="app-container">
        ...
        <el-table v-loading="listLoading" :data="list" border fit style="width: 100%" >
            ...
            <el-table-column align="center" label="操作" width="120">
                <template slot-scope="scope">
                    <el-button type="primary" size="small" icon="el-icon-view" @click="renderJobInfo(scope.row.jobId, scope.row.companyName, scope.row.reportReason)">
                        处理
                    </el-button>
                </template>
            </el-table-column>
        ...
        <el-dialog :visible.sync="dialogVisible" title="职位信息审核" width="750px" top="5vh">
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="dialogVisible = false">删除职位</el-button>
...
<script>
import { getReportList, getJobInfo } from '@/api/report'
...
export default {
    ...
    methods: {
        ...
        renderJobInfo(jobId, companyName, reportReason) {
